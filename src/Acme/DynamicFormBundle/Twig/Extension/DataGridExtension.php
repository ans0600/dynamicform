...
namespace Acme\DynamicFormBundle\Twig\Extension;


use Acme\DynamicFormBundle\Services\DataGrid\DataGridService;
...
class DataGridExtension extends \Twig_Extension {
  ...
  {
    return $this->renderBlock('grid',array('dg'=>$dataGrid));
